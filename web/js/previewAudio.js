...
function previewAudio(node,file,subfolder){
...
app.registerExtension({
	name: "AudioLiam.AudioPreviewer",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData?.name == "PreViewAudioLiam") {
            //console.log("AudioPreviewer-registerExtension:"+nodeData?.name)
